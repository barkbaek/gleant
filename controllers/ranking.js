const model = require('../models/ranking');
const methods = require('../methods');
const i18n = require('../i18n');
const config = require('../env.json')[process.env.NODE_ENV || 'development'];

module.exports = function (lang, is_mobile, is_loginned, user, template) {
    template.render('ranking', {
        lang: function () {
            if (lang === undefined) {
                lang = "en";
            }
        ...
        title: function () {
            ...
            return i18n[lang].ranking_obj.title;
        },
        description: function () {
            ...
            return i18n[lang].ranking_obj.description;
        },
        keywords: function () {
