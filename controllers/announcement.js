...
module.exports = function (lang, is_mobile, is_loginned, user, announcements, template) {
    template.render('announcement', {
        lang: function () {
            if (lang === undefined) {
                lang = "en";
            }
        ...
        title: function () {
            ...
            return i18n[lang].announcement_obj.title;
        },
        description: function () {
            ...
            return i18n[lang].announcement_obj.description;
        },
        keywords: function () {
        ...
        announcements: function () {
            ...
            if (announcements === null ||
                ...
                for (var i = 0; i < announcements.length; i++) {
                    ...
                    final = final + article_templates.get_single_perfect_gleant_announcement(lang, temp);
                }
                return final;
            }
        },
        is_more: function () {
            if ((announcements === null) || (announcements.length < limit.announcements)) {
                return false;
            } else {
                return true;
            }
