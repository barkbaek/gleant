const model = require('../models/single_agenda');
const methods = require('../methods');
const i18n = require('../i18n');
const article_templates = require('../article_templates');
const config = require('../env.json')[process.env.NODE_ENV || 'development'];

module.exports = function (lang, is_mobile, is_loginned, user, agenda, template) {
    template.render('single_agenda', {
        lang: function () {
            if (lang === undefined) {
                lang = "en";
            }
        ...
        title: function () {
            return agenda.title + " - " + i18n[lang].agenda_obj.title;
        },
        ...
        url: function () {
            return config["url"] + '/agenda/' + agenda._id;
        },
        alternate_list: function () {
            var list = [];
            var url = config["url"] + '/agenda/' + agenda._id;
        ...
        agenda: function () {
            ...
            if (user === null) {
                return article_templates.get_single_perfect_article(lang, agenda, is_mobile, is_loginned, null, 'agenda');
            } else {
                return article_templates.get_single_perfect_article(lang, agenda, is_mobile, is_loginned, user["blog_id"], 'agenda');
            }
        },
        main_tag: function () {
            return agenda.main_tag;
        },
        i18n_main_tag: function () {
            ...
            return agenda.main_tag === undefined ? "" : i18n[lang][agenda.main_tag];
        }
    });
};