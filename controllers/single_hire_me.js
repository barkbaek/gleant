const model = require('../models/single_hire_me');
...
module.exports = function (lang, is_mobile, is_loginned, user, doc, template) {
    template.render('single_hire_me', {
        lang: function () {
            if (lang === undefined) {
                lang = "en";
            }
        ...
        title: function () {
            return doc.title + " - " + i18n[lang].hire_me + " - " + i18n[lang].employment_obj.title;
        },
        ...
        url: function () {
            return config["url"] + '/hire-me/' + doc._id;
        },
        alternate_list: function () {
            var list = [];
            var url = config["url"] + '/hire-me/' + doc._id;
        ...
        realtime_hire_me: function () {
            if (
                lang === "en" ||
                lang === "ko"
            ) {
                str = i18n[lang].realtime  + " " + i18n[lang].hire_me;
            } else {
                str = i18n[lang].realtime + i18n[lang].hire_me;
            }
            return str;
