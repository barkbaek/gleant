...
module.exports = function (lang, is_mobile, is_loginned, user, announcements, template) {
    template.render('premium_link_announcement', {
        ...
        title: function () {
            ...
            var title = i18n[lang].premium_link_obj.title;
            if (
                lang === "en" ||
                lang === "ko"
            ) {
                title = title + " " + i18n[lang].announcement;
            } else {
                title = title + i18n[lang].announcement;
            }
            return title;
