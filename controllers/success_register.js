const model = require('../models/success_register');
const config = require('../env.json')[process.env.NODE_ENV || 'development'];
const i18n = require('../i18n');

module.exports = function (lang, template) {
    template.render('success_register', {
        lang: function () {
            if (lang === undefined) {
                lang = "en";
            }
        ...
        title: function () {
            ...
            return i18n[lang].success_register_obj.title;
        },
        description: function () {
            ...
            return i18n[lang].success_register_obj.description;
        },
        date: function () {
