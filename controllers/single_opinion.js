const model = require('../models/single_opinion');
const methods = require('../methods');
const i18n = require('../i18n');
const article_templates = require('../article_templates');
const config = require('../env.json')[process.env.NODE_ENV || 'development'];

module.exports = function (lang, is_mobile, is_loginned, user, opinion, template) {
    template.render('single_opinion', {
        lang: function () {
            if (lang === undefined) {
                lang = "en";
            }
        ...
        title: function () {
            return opinion.title + " - " + i18n[lang].opinion_obj.title;
        },
        ...
        url: function () {
            return config["url"] + '/agenda/' + opinion.agenda_id + '/opinion/' + opinion._id;
        },
        alternate_list: function () {
            var list = [];
            var url = config["url"] + '/agenda/' + opinion.agenda_id + '/opinion/' + opinion._id;
        ...
        opinion: function () {
            ...
            if (user === null) {
                return article_templates.get_single_perfect_article(lang, opinion, is_mobile, is_loginned, null, 'opinion');
            } else {
                return article_templates.get_single_perfect_article(lang, opinion, is_mobile, is_loginned, user["blog_id"], 'opinion');
            }
        },
        main_tag: function () {
            return opinion.main_tag;
        },
        i18n_main_tag: function () {
            ...
            return opinion.main_tag === undefined ? "" : i18n[lang][opinion.main_tag];
        }
    });
};