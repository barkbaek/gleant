const model = require('../models/write_announcement');
...
module.exports = function (lang, is_mobile, is_loginned, user, query, template) {
    template.render('write_announcement', {
        lang: function () {
            if (lang === undefined) {
                lang = "en";
            }
        ...
        form_top: function () {
            ...
            return article_templates.get_single_gleant_announcement_form(lang).form_top;
        },
        form_bottom: function () {
            if (lang === undefined) {
                lang = "en";
            }
            if (
            ...
            return article_templates.get_single_gleant_announcement_form(lang).form_bottom;
        },
        cms_menu: function () {
            if (lang === undefined) {
                lang = "en";
        ...
        cms_sub_menu: function () {
            ...
            if (query.action === 'write') {
                cms_sub_menu = "<ul><a href='/cms?type=announcement&action=write'><li class='selected'>" + i18n[lang].announcement_writing + "</li></a><a class='preparing-service' href='/cms?type=announcement&action=list'><li class=''>" + i18n[lang].announcement_list + "</li></a></ul>";
            } else {
                cms_sub_menu = "";
            }
            return cms_sub_menu;
